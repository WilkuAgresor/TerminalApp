...
static int initSensor(bool longRange);
...
//
int tofInit(int iChan, int iAddr, bool longRange)
{
    char filename[32];
    ...
    return initSensor(longRange); // finally, initialize the magic numbers in the sensor
